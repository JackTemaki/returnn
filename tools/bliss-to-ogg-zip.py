...
def main():
  ...
  arg_parser.add_argument("--no_conversion", help="skip ffmpeg conversion call, assume audio is already correct",
                          action="store_true")
  ...
  for seq in seqs:
    ...
    if args.no_ogg:
      ...
      if args.no_conversion:
        ...
        os.path.basename(rec_filename), dest_filename[len(dest_dirname) + 1:]))
